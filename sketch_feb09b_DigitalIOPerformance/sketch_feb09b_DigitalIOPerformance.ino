...
On the scope the o/p is greater than the i/p by the calPercent. Fixed the every
5th missed interrupt using the digitalIOPerformance macro and an 'if' compare
