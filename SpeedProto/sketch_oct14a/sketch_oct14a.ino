//Program outputs Hello World to a display
#include <SPI.h>
#include <Andee.h>
...
void setup(){
  ...
  digitalWrite(2, OUTPUT); //I enabled the pullup resistor attached to this pin2
  ...
  wheelCircumference = (2.0*pi*radius)/100000;
  totalDistance = 0.0;
  loopTime = millis();
}
...
//When sensor pin makes a High to Low or Low to High, isr(void) will be called. 
void isr(void){
