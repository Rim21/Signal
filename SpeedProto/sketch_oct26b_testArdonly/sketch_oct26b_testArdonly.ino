...
//volatile unsigned long wheelCircum = 2268;  //circ circumference in millimeters
// Sensor setup
const int debounce = 10000; //equates to 5 milliseconds;
...
//  pulseCircum = wheelCircum/6; //2268mm / 6 pulses
//pinMode (13, OUTPUT);                        
