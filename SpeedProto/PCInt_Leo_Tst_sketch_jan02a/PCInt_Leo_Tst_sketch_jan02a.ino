...
volatile boolean speedFlag = false;
//#define phaseOflag 2
//#define phaseGflag 4
//#define phaseYflag 8
...
volatile boolean uFlagsShared = false;
...
void setup()
{
  ...
  PCintPort::attachInterrupt(sensorPin, speedSense,CHANGE);
...
void loop()
{
 ...
 //uint8_t uFlags = 0;
  ...
  //if (currentPOmicros-modprePOspeed<1000000) 
  //{
  ...
  //if (currentPGmicros-modprePGspeed<1000000) 
  //{
  ...
  //if (currentPYmicros-modprePYspeed<1000000) 
  //{
