...
// This sketch works for a Leo board using Pin Change Interrupts
...
// Sensor setup
const int debounce = 50; //equates to 250 microseconds;
...
void loop()
{
 ...
 static uint16_t modPYinterval; 
  ...
  // only used the local value modInterval here as the shared variable interval is owned by
