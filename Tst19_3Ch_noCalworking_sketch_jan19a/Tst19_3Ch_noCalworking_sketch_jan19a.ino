...
void loop()
{
  ...
  {
    if(currentTime-phaseOprevious > ((phaseOinterval/2)/calPercent))
    {
  ...
  {
    if(currentTime-phaseGprevious > ((phaseGinterval/2)/calPercent))
    {
  ...
  {
    if(currentTime-phaseYprevious > ((phaseYinterval/2)/calPercent))
    {
